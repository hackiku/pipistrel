### data.py
### raw data, specs, dataframes and table manipulation functions
...
airfoil_data = [
    ...
    ["NACA 63_1-212", 9.0, -2.0, 0.110, 1.62, "D", 14.5, 0.25, 11.4, 0.0045, -0.034, 0.263, -0.029],
    ["NACA 63_2-215", 9.0, -1.2, 0.120, 1.61, "D", 15.0, 0.20, 11.0, 0.0046, -0.031, 0.267, -0.020],
    ["NACA 63_3-218", 9.0, -1.2, 0.120, 1.50, "D", 16.0, 0.20, 11.0, 0.0049, -0.032, 0.271, -0.042],
    ["NACA 63_4-221", 9.0, -1.3, 0.110, 1.46, "D", 15.0, 0.20, 11.0, 0.0053, -0.030, 0.269, -0.033],
    ["NACA 63_1-412", 9.0, -3.0, 0.100, 1.78, "D", 15.0, 0.32, 9.6, 0.0045, -0.075, 0.270, -0.073],
    ["NACA 63_2-415", 9.0, -3.0, 0.115, 1.67, "D", 15.0, 0.35, 10.0, 0.0049, -0.071, 0.262, -0.036],
    ["NACA 63_3-418", 9.0, -2.6, 0.118, 1.58, "D", 16.0, 0.22, 8.5, 0.0050, -0.071, 0.272, -0.051],
    ["NACA 63,4-420", 9.0, -2.1, 0.110, 1.42, "D", 15.0, 0.05, 9.0, 0.0055, -0.060, 0.265, -0.054],
    ["NACA 63,4-420, a=0.3", 9.0, -2.5, 0.108, 1.35, "D", 16.0, 0.45, 8.0, 0.0058, -0.036, 0.265, 0.000],
